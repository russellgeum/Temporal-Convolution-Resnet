...
class MFCC(torch.nn.Module):
    def __init__(
        self, samplerate = 16000, winlen = 0.025, winstep = 0.01, numcep = 13, nfilt = 26, nfft = None, lowfreq = 0, highfreq = None, preemph = 0.97, ceplifter = 22, appendEnergy = True):
    ...
    def magspec(self,frames):
        ...
        complex_spec = torch.fft.rfft(frames,1)
